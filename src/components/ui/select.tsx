...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        "flex h-10 w-full items-center justify-between gap-2 rounded-xl border border-input bg-input/30 px-3.5 text-sm text-foreground shadow-sm outline-none transition-colors",
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          "glass-card relative z-[200] max-h-96 min-w-[8rem] overflow-hidden rounded-xl p-1 shadow-2xl",
