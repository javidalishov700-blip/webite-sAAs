  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto max-h-[92vh] flex-col rounded-t-3xl border-t border-white/10 bg-[color-mix(in_oklab,var(--card)_92%,transparent)] backdrop-blur-2xl",
