...
import { BarChart3, LayoutGrid, Package, Plus, QrCode as QrCodeIcon, Radar, Smartphone } from "lucide-react";
  ...
  return (
    <div>
      ...
      {summary && summary.totalScans === 0 ? (
        <Card className="mt-6">
          <CardHeader>
            <CardTitle>{t("noScansTitle")}</CardTitle>
            <CardDescription>{t("noScansBody")}</CardDescription>
          </CardHeader>
          <CardContent>
